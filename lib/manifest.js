/* ============================================================================
   ...
   Si algo no se actualiza, sube el número de "?v=" en index.html
   (por ejemplo de v=20260629 a v=20260630).
   ========================================================================== */
...
window.__HINETLY__ = {
  ...
  contacto: {
    whatsapp: "521234567890",                 // <-- TU NÚMERO AQUÍ
    whatsappVisible: "+52 123 456 7890",       // como se muestra en pantalla
    mensajeWhatsapp: "Hola Hinetly, quiero cotizar una web para mi negocio.",
    instagram: "https://instagram.com/hinetly",
    instagramVisible: "@hinetly",
