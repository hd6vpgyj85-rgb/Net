...
window.__HINETLY__ = {
  ...
  plantillas: [
    {
      ...
      items: [
        ...
        { nombre: "Plantilla de restaurante 02", url: "https://6a456365d14001baef8f149c--bright-gumdrop-27da0e.netlify.app/" }
      ]
    },
    {
      id: "esteticas",
  ...
  /* ---- TIENDA · PELUCHES (sección 04) -------------------------------------
     Los peluches a la venta. Para cada uno:
       - nombre: el título visible
       - precio: el texto del precio (ej. "$200 MXN")
       - imagen: ruta a la foto dentro de assets/products/
       - mensaje: (opcional) texto que se envía por WhatsApp al apartarlo.
                  Si lo borras, se arma uno automático con el nombre y precio.
     Para añadir un peluche, copia un bloque { ... } y pégalo con una coma
     antes. Para quitarlo, borra su bloque (y la coma sobrante).

     ⚠️ LAS FOTOS: pon los archivos en la carpeta assets/products/ con el
        MISMO nombre que pongas aquí en "imagen". La portada (Garfield) va
        aparte: archivo  assets/products/portada-garfield.jpg  (ver README). */
  productos: [
    {
      nombre: "Cinnamoroll Conejito",
      precio: "$200 MXN",
      imagen: "assets/products/cinnamoroll.jpg"
    },
    {
      nombre: "Snoopy",
      precio: "$200 MXN",
      imagen: "assets/products/snoopy.jpg"
    },
    {
      nombre: "Osito Caramelo",
      precio: "$200 MXN",
      imagen: "assets/products/osito.jpg"
    },
    {
      nombre: "Conejito Blanco",
      precio: "$200 MXN",
      imagen: "assets/products/conejito.jpg"
    }
  ],
  ...
  nav: [
    ...
    { num: "04", label: "Tienda",     href: "#tienda" },
    { num: "05", label: "Proceso",    href: "#proceso" },
